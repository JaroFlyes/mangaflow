...
export default function RegistroPage() {
  ...
  const inputClass = "w-full bg-[#0d0d0d] border border-white/10 rounded-xl px-4 py-3 text-white text-sm placeholder:text-white/20 focus:outline-none focus:border-[#e94560]/50 focus:ring-2 focus:ring-[#e94560]/10 transition"
    ...
    <div className="min-h-screen bg-[#0d0d0d] flex items-center justify-center px-4">
      ...
      <div className="relative w-full max-w-sm">
        <div className="text-center mb-10">
          ...
          <p className="text-[#555] text-sm mt-3">Crie sua conta grátis</p>
        </div>
        ...
        <p className="text-center text-[#555] text-sm mt-6">
          Já tem conta?{' '}
          <Link href="/login" className="text-[#e94560] hover:text-[#ff6b84] font-semibold transition">Entrar</Link>
        </p>
      </div>
    </div>
  )
